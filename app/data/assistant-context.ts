...
const recommendations: Array<{ terms: string[]; reply: string; links: AssistantLink[] }> = [
  ...
  { terms: ["hire", "resume", "cv", "experience", "recruiter", "job"], reply: "The recruiter fast-track page summarizes Usaid’s experience, stack, selected project evidence, working model, and downloadable CV. It is the quickest route for evaluating role fit.", links: [{ href: "/hire-me", label: "Hiring profile" }, { href: "/Usaid-Ahmed-CV.pdf", label: "Download CV" }] },
