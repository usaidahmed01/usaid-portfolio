...
export default async function BlogPostPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const schema = { "@context": "https://schema.org", "@type": "BlogPosting", headline: post.title, description: post.description, datePublished: new Date(post.date).toISOString(), author: { "@type": "Person", name: "Usaid Ahmed", url: "https://usaid-portfolio-sooty.vercel.app/about" }, articleSection: post.category, mainEntityOfPage: `https://usaid-portfolio-sooty.vercel.app/blog/${slug}` };
