...
export default function BookACallPage() {
  const calendarUrl = process.env.NEXT_PUBLIC_CALCOM_URL;
  return <><Header /><main className="booking-page">
    <section className="booking-grid shell">
      ...
      {calendarUrl ? <div className="calendar-embed"><div className="booking-form-head"><span><i /> LIVE CALENDAR</span><strong>Select a suitable time</strong></div><iframe src={calendarUrl} title="Book a 30-minute call with Usaid Ahmed" loading="lazy" /><a className="calendar-direct" href={calendarUrl} target="_blank" rel="noreferrer" data-track="calendar_open_external">Open calendar in a new tab ↗</a></div> : <BookingForm />}
    </section>
