...
export default async function WorkDetailPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  const schema = { "@context": "https://schema.org", "@graph": [{ "@type": ["Project", "CreativeWork"], name: project.title, description: project.summary, creativeWorkStatus: project.status, creator: { "@type": "Person", name: "Usaid Ahmed" }, keywords: project.tags.join(", ") }, { "@type": "BreadcrumbList", itemListElement: [{ "@type": "ListItem", position: 1, name: "Work", item: "https://usaid-portfolio.basit-ahmed906.chatgpt.site/work" }, { "@type": "ListItem", position: 2, name: project.title, item: `https://usaid-portfolio.basit-ahmed906.chatgpt.site/work/${project.slug}` }] }] };
